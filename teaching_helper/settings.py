"""
Django settings for teaching_helper project.
...
SECRET_KEY = ')d5u8tcmc*i^y7_j@c+79f!t3+!h=0ug$$n@7&h#+tf(6s&#wz'
...
ROOT_URLCONF = 'teaching_helper.urls'

AUTH_USER_MODEL = 'wx_client.UserProfile'
...
WSGI_APPLICATION = 'teaching_helper.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'wx_client.components.authentication.JWTokenAuth',
